declare module "blakejs" {
    ...
    export function blake2b(data: Uint8Array | string, key: Key, outlen: number): Uint8Array;
    export function blake2bHex(data: Uint8Array | string, key: Key, outlen: number): string;
    ...
    export function blake2s(data: Uint8Array | string, key: Key, outlen: number): Uint8Array;
    export function blake2sHex(data: Uint8Array | string, key: Key, outlen: number): string;
