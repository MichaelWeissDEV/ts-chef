/**
 * @fileoverview RC2Encrypt operation - Ported from GCHQ's CyberChef
 ...
 */
export class RC2Encrypt extends TypedOperation<string, string, unknown[]> {
  /**
  ...
  run(input: string, args: unknown[]): string {
    const [arg0, arg1, inputType, outputType] = args as [
