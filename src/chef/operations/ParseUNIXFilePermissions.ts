/**
 * @fileoverview ParseUNIXFilePermissions operation - Ported from GCHQ's CyberChef
 ...
 */
export class ParseUNIXFilePermissions extends TypedOperation<string, string, unknown[]> {
  /**
