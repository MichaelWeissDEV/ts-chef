/**
 * @fileoverview ECDSASignatureConversion operation - Ported from GCHQ's CyberChef
 ...
 */
export class ECDSASignatureConversion extends TypedOperation<string, AnyInput, unknown[]> {
  /**
