/**
 * @fileoverview BLAKE2s operation - Ported from GCHQ's CyberChef
 ...
 */
export class BLAKE2s extends TypedOperation<ArrayBuffer, string, unknown[]> {
  constructor() {
    super();
    this.name = "BLAKE2s";
    this.module = "Hashing";
    ...
    switch (outFormat) {
      ...
      case "Raw":
        return Utils.arrayBufferToStr(
          blakejs.blake2s(data, key, sizeBytes).buffer as ArrayBuffer,
          false,
        );
      default:
