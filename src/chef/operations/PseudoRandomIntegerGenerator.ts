/**
 * @fileoverview PseudoRandomIntegerGenerator operation - Ported from GCHQ's CyberChef
...
export class PseudoRandomIntegerGenerator extends TypedOperation<string, string, unknown[]> {
