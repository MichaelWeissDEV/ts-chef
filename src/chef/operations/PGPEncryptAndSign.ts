/**
 * @fileoverview PGPEncryptAndSign operation - Ported from GCHQ's CyberChef
 ...
 */
export class PGPEncryptAndSign extends TypedOperation<string, Promise<string>, unknown[]> {
  /**
