/**
 * @fileoverview HASSHServerFingerprint operation - Ported from GCHQ's CyberChef
 ...
 */
export class HASSHServerFingerprint extends TypedOperation<string, string, unknown[]> {
  /**
