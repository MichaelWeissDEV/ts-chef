/**
 * @fileoverview Bzip2Decompress operation - Ported from GCHQ's CyberChef
...
export class Bzip2Decompress extends TypedOperation<ArrayBuffer, Promise<ArrayBuffer>, unknown[]> {
  /**
