/**
 * @fileoverview ContainImage operation - Ported from GCHQ's CyberChef
 ...
 */
export class ContainImage extends TypedOperation<ArrayBuffer, Promise<ArrayBuffer>, unknown[]> {
  /**
  ...
  async run(input: ArrayBuffer, args: unknown[]): Promise<ArrayBuffer> {
    const [width, height, hAlign, vAlign, alg, opaqueBg] = args as [
      number,
      number,
      string,
      string,
