/**
 * @fileoverview SHA1.test module for ts-chef extension
 * @package core
 * @license Apache-2.0
...
describe("SHA1", () => {
  ...
  test("SHA1 of empty string", () => {
    expect(op.run(strToAB(""), [80])).toBe(
      "da39a3ee5e6b4b0d3255bfef95601890afd80709",
    );
  });

  test("SHA1 of 'hello'", () => {
    expect(op.run(strToAB("hello"), [80])).toBe(
  ...
  test("SHA1 of 'The quick brown fox jumps over the lazy dog'", () => {
    expect(
      op.run(strToAB("The quick brown fox jumps over the lazy dog"), [80]),
